...
namespace UnityPlayingLogic.Cameras
{
    [ExecuteInEditMode]
    public class CameraMoveUpPosition : PivotBasedCamera
    {
        ...
        [SerializeField] private float m_Back = 11f;
        [SerializeField] private float m_Up = 6f;
        ...
        protected override void FollowTarget(float deltaTime)
        {
            ...
            transform.position = Vector3.Lerp(transform.position, m_Target.position + (Vector3.up * m_Up) + (Vector3.back * m_Back), deltaTime * m_MoveSpeed);
